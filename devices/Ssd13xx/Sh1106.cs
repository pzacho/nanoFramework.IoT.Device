...
namespace Iot.Device.Ssd13xx
{
    ...
    public class Sh1106 : Ssd13xx
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Sh1106" /> class that will communicate using I2C bus.
        /// A single-chip CMOS OLED/PLED driver with controller for organic/polymer
        /// light emitting diode dot-matrix graphic display system.
        /// </summary>
        /// <param name="i2cDevice">The I2C device used for communication.</param>
        public Sh1106(I2cDevice i2cDevice) : base(i2cDevice, offset: 2)
        {
        }
        ...
        public Sh1106(I2cDevice i2cDevice, DisplayResolution res) : base(i2cDevice, res, offset: 2)
        {
        }
